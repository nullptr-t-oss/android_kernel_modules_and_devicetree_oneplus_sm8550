...
def main():
    ...
    if os.path.exists('kernel_platform/common/build.config.constants'):
        print("this is kernel 5.15 version")
        ...
        src_and_targets = [
            ...
            ('kernel_platform/out/msm-*-gki/dist/vmlinux.symvers', 'out/oplus/vmlinux.symvers'),
        ...
        print("this is kernel 5.10 version")
        CLANG_PREBUILT_BIN = "kernel_platform/prebuilts-master/clang/host/linux-x86/clang-r416183b/bin/:"
        # example: Predefining source and target files
        src_and_targets = [
            ('kernel_platform/oplus/aosp_gki/vmlinux.symvers', 'out/oplus/vmlinux_gki.symvers'),
            ('kernel_platform/out/msm-*-gki/dist/vmlinux.symvers', 'out/oplus/vmlinux.symvers'),
            ('kernel_platform/oplus/aosp_gki/vmlinux', 'out/oplus/vmlinux'),
            ('kernel_platform/oplus/config/abi_symbols_tmp_approval.csv', 'out/oplus/abi_symbols_tmp_approval.csv'),
            ('out/target/product/vnd/vendor_ramdisk/lib/modules/modules.load.recovery', 'out/oplus/modules.load.recovery')
        ]
